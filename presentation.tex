...
%*-------------------------------------------------------------------------------
\title              {Manipuladores}
\subtitle           {Projetos da linha de pesquisa}
\author             {Juliana Santana, Gabriel Calmon, João Carvalho, Tiago Barreto e Vagner Silva}
...
%   \input{Sections/walker.tex}
%  \input{Sections/warthog-aum.tex}
